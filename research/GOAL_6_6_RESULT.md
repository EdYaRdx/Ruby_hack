...
[GitHub Actions run 34032883972](https://github.com/EdYaRdx/Ruby_hack/actions/runs/34032883972)
завершён с `success`; подтверждены все четыре комбинации Windows/Linux × Ruby
3.3/4.0. Это не изменяет продуктовую семантику.
