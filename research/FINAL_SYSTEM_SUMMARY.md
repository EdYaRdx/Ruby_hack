...
> **ИСТОРИЧЕСКИЙ RESEARCH SNAPSHOT.** Текст фиксирует состояние и решения на
> дату review; текущая реализация и ограничения описаны в
> [`docs/ARCHITECTURE.md`](../docs/ARCHITECTURE.md) и корневом README.
